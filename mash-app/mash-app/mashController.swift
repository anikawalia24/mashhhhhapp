...
class mashController: UIViewController {
    ...
    let mashWithImage = ["kyliejenner", "drake", "joejonas", "monkey", "arianagrande", "tomholland", "jacobsartorius", "jamesfranco", "selenagomez", "daviddobrik", "beyonce", "zendaya", "jojosiwa", "billieeilish", "dracomalfoy", "eggsy", "jakegyllenhaal", "cdc"]
    ...
    let mashWithCarImage = ["jeep", "mercedes", "tricycle", "tesla", "lightningmcqueen", "silverferrari", "scoobydoovan"]
